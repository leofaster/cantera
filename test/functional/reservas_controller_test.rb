...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { cant_horas: @reserva.cant_horas, fecha_ingreso: @reserva.fecha_ingreso, hora_inicio: @reserva.hora_inicio, tipo_cancha: @reserva.tipo_cancha, usuario_id: @reserva.usuario_id }
    end
  ...
  test "should update reserva" do
    put :update, id: @reserva, reserva: { cant_horas: @reserva.cant_horas, fecha_ingreso: @reserva.fecha_ingreso, hora_inicio: @reserva.hora_inicio, tipo_cancha: @reserva.tipo_cancha, usuario_id: @reserva.usuario_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
